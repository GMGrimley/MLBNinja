    ...
    <div id="fixtures" style="display: none;">
      ...
      <form id="troubleForm" action="">
        <p>
          ...
          <input type="text" name="disabled_text_field" id="disabled_text_field" disabled>
          <input type="text" name="enabled_text_field" id="enabled_text_field">
          <input type="checkbox" name="checkboxes" id="checked_box" checked value="Checked">
          <input type="checkbox" name="checkboxes" id="unchecked_box" value="Unchecked">
          <input type="radio" name="radiobuttons" id="checked_radio" checked value="Checked">
      ...
      <form id="troubleForm2" action="">
        <p>
          <input type="checkbox" name="brackets[5][]" id="chk_1" checked value="1">
